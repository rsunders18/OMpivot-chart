...
{
  [Table("sp_ShiftReportHeader", Schema = "App")]
  public partial class SpShiftReportHeader
  {
    [Key]
    public int RowID
    {
    ...
    [DatabaseGenerated(DatabaseGeneratedOption.Computed)]
    public string TotalStopTimeChar
    {
      get;
      set;
    }
    ...
    [DatabaseGenerated(DatabaseGeneratedOption.Computed)]
    public string TotalStopTimeHChar
    {
      get;
      set;
    }
