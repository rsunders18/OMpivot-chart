...
{
  [Table("SH1_Assembly_5202_PerBatch_PerCycle", Schema = "dbo")]
  public partial class Sh1Assembly5202PerBatchPerCycle
  {
    [Key]
    ...
    [Column("STN 20: CF26 20_1B23 Boot Remover Insertion")]
    public int? STN20CF2620_1B23BootRemoverInsertion
    {
      get;
      set;
    }
    ...
    [Column("STN 22 : CF17 22_1aB12 Print Present")]
    public int? STN22CF1722_1aB12PrintPresent
    {
      get;
      set;
    }
