...
{
  [Table("sp_BacthReportHeader", Schema = "App")]
  public partial class SpBacthReportHeader
  {
    [Key]
    public int RowID
    {
    ...
    public string RecordedOnDateChar
    {
      get;
      set;
    }
    ...
    [DatabaseGenerated(DatabaseGeneratedOption.Computed)]
    public decimal? PcsPerHourPercent
    {
      get;
      set;
    }
    ...
    public decimal? BatchEfficiencyPercent
    {
      get;
      set;
    }
